...
A table dissolves by default after 2 weeks unless there is a clear reason to renew or remix.
...
## Active Table Commitment

Liquid Builder Tables are for active participants.

A participant is active when they contribute to the table outcome through visible work, useful feedback, blocker removal, research, testing, documentation, or implementation.
...
Liquid Builder Tables run on a simple two-week rhythm:
